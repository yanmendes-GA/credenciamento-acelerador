...
export const ToggleSwitch: React.FC<ToggleSwitchProps> = ({ selectedOption, onToggle }) => {
  return (
    <div 
      className="flex w-[313px] justify-center items-start gap-2 relative bg-[#101820] p-1.5 rounded-[18px] max-md:w-full max-md:max-w-[313px] max-sm:w-full"
      role="tablist"
    ...
    >
      <button
        ...
        className={`flex justify-center items-center gap-2.5 flex-[1_0_0] relative px-1.5 py-[3px] rounded-xl transition-colors ${
